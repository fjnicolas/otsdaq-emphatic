//
//  emphatic-artdaq/Generators/CAENV1720Readout.hh
//  Copied from 1730 code - not confirmed to work yet
//

#ifndef emphatic_artdaq_Generators_CAENV1720Readout_hh
#define emphatic_artdaq_Generators_CAENV1720Readout_hh
...
{
class CAENV1720Readout : public artdaq::CommandableFragmentGenerator
{
  public:
	explicit CAENV1720Readout(fhicl::ParameterSet const& ps);
	virtual ~CAENV1720Readout();
